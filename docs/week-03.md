...
| 질문 | 후보 A | 후보 B | 후보 C |
|---|---|---|---|
| 이 안에 **누구의 정보**가 들어가는가<br>그 사람이 우리 사용자와 같은 사람인가 | 최근 들어 불규칙적인 수면과 지각을 종종 겪는 대학생 A씨 |  |  |
| 쓰고 싶어도 **못 쓰는 사람**은 누구인가 | 없다. 잠과 시간은 시대를 불문하고 인간의 삶에서 가장 중요한 개념으로 자리 잡고 있기 때문이다. 모두가 이용할 수 있을거라 생각한다. |  |  |
